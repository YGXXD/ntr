...
int main()
{
    try
    {
        ...
        NTR_TEST_ASSERT(!obj_new.is_ref());
        ...
        NTR_TEST_ASSERT(!kutori_obj.is_ref());
        NTR_TEST_ASSERT(kutori_obj.is_valid());
        NTR_TEST_ASSERT(kutori_obj.as<kutori>().get_value() != nullptr);

        nobject kutori_obj_hold = kutori_obj.hold();
        // check data is referenced
        NTR_TEST_ASSERT(kutori_obj_hold.type() == nephren::get<kutori>());
        NTR_TEST_ASSERT(kutori_obj_hold.is_ref());
        NTR_TEST_ASSERT(kutori_obj_hold.is_valid());
        NTR_TEST_ASSERT(kutori_obj_hold.as<kutori>().get_value());

        nobject kutori_obj_clone = kutori_obj.clone();
        NTR_TEST_ASSERT(kutori_obj_clone.type() == nephren::get<kutori>());
        NTR_TEST_ASSERT(!kutori_obj_clone.is_ref());
        ...
        NTR_TEST_ASSERT(!kutori_obj_steal.is_ref());
